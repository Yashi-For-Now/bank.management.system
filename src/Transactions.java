...
public class Transactions extends JFrame implements ActionListener{
    ...
    JButton deposit, fastcash, cwithdrawl, ministatement, pinchange, balenquiry, exit;
    String pinnumber;
    Transactions(String pinnumber){
        ...
        cwithdrawl= new JButton("Cash Withdrawl");
        cwithdrawl.setBounds(355, 415, 150, 30);
        cwithdrawl.addActionListener(this);
        image.add(cwithdrawl);
